...
export default function AdminPagesClient({
  ...
  const handleSeed = async () => {
    ...
    try {
      ...
      await refreshPages();
      alert(
        `${tAdmin("seedTermsPrivacy")}: ${tCommon("create")} (${created.length}), ${tCommon("update")} (${updated.length})`,
      );
    } finally {
      setSeeding(false);
    }
              ...
              >
                ...
                <td className="px-4 py-3">
                  <span
                    className={
                      page.showInMenu
                        ? "rounded px-2 py-0.5 text-[11px] font-semibold bg-green-100 text-green-700"
                        : "rounded px-2 py-0.5 text-[11px] font-semibold bg-gray-100 text-gray-500"
                    }
                  >
                ...
                <td className="px-4 py-3">
                  <span
                    className={
                      page.status === 1
                        ? "rounded px-2 py-0.5 text-[11px] font-semibold bg-green-100 text-green-700"
                        : "rounded px-2 py-0.5 text-[11px] font-semibold bg-amber-100 text-amber-700"
                    }
                  >
