    ...
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <nav className="flex gap-1 text-sm">
          <span className="px-3 py-1.5 bg-green-50 text-green-700 rounded-lg font-medium">{t('general')}</span>
          <Link href="/settings/whatsapp" className="px-3 py-1.5 text-gray-600 hover:bg-gray-100 rounded-lg">{t('whatsapp')}</Link>
          <Link href="/settings/profile" className="px-3 py-1.5 text-gray-600 hover:bg-gray-100 rounded-lg">{t('profile')}</Link>
        </nav>
      </div>
