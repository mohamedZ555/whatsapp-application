...
import { CreditCard, FileText, Gauge, Globe, Settings2, Users } from 'lucide-react';
...
type AdminNavItem = {
  key: string;
  href: string;
  labelKey: 'dashboard' | 'vendors' | 'subscriptions' | 'translations' | 'pages' | 'configuration';
...
const navItems: AdminNavItem[] = [
  ...
  { key: 'translations', href: '/admin/translations', labelKey: 'translations', icon: Globe },
    ...
    <aside className="w-[268px] border-e border-emerald-800/70 bg-gradient-to-b from-emerald-950 via-emerald-900 to-emerald-950 text-emerald-50">
      <div className="h-16 border-b border-emerald-800/70 px-5">
          <div className="flex h-full items-center gap-3">
            ...
            <div>
              <p className="text-[11px] uppercase tracking-[0.14em] text-emerald-200/80">{tAdmin('title')}</p>
